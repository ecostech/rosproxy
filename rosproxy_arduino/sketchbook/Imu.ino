...
#ifdef _IMU_PROXY
rosproxy_msgs::Imu imu_msg;
ros::Publisher imu_pub("rosproxy/imu", &imu_msg);
#else
...
void imu_covar_callback(const rosproxy_msgs::RequestImuCovariancesRequest& req, rosproxy_msgs::RequestImuCovariancesResponse& res)
{
...
ros::ServiceServer<rosproxy_msgs::RequestImuCovariancesRequest, rosproxy_msgs::RequestImuCovariancesResponse> imu_covar_server("rosproxy/imu_covar_srv",&imu_covar_callback);
#endif

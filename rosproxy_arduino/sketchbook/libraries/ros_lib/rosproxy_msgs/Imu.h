#ifndef _ROS_rosproxy_msgs_Imu_h
#define _ROS_rosproxy_msgs_Imu_h
...
namespace rosproxy_msgs
{
  ...
  class Imu : public ros::Msg
  {
    public:
      ...
      rosproxy_msgs::Vector3 angular_velocity;
      float angular_velocity_covariance[3];
      rosproxy_msgs::Vector3 linear_acceleration;
    ...
    const char * getType(){ return "rosproxy_msgs/Imu"; };

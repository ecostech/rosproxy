#ifndef _ROS_rosproxy_msgs_OdometryCovariances_h
#define _ROS_rosproxy_msgs_OdometryCovariances_h
...
namespace rosproxy_msgs
{
  ...
  class OdometryCovariances : public ros::Msg
  {
    ...
    const char * getType(){ return "rosproxy_msgs/OdometryCovariances"; };

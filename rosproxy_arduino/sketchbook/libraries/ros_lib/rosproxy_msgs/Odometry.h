#ifndef _ROS_rosproxy_msgs_Odometry_h
#define _ROS_rosproxy_msgs_Odometry_h
...
#include "rosproxy_msgs/Pose.h"
#include "rosproxy_msgs/Twist.h"
...
namespace rosproxy_msgs
{
  ...
  class Odometry : public ros::Msg
  {
    public:
      ...
      rosproxy_msgs::Pose pose;
      float pose_covariance[6];
      rosproxy_msgs::Twist twist;
    ...
    const char * getType(){ return "rosproxy_msgs/Odometry"; };
